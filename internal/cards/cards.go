...
// Cards holds the information needed by this package
type Card struct {
	Secret   string
	Key      string
	Currency string
...
// Transaction is the type to store information for given transaction
...
func (c *Card) SubscribeToPlan(cust *stripe.Customer, plan, email, last4, cardType string) (*stripe.Subscription, error) {
	...
	params.AddMetadata("lst_four", last4)
...
func cardErrorMessage(code stripe.ErrorCode) string {
	...
	case stripe.ErrorCodeAmountTooSmall:
		msg = "The amount is too small to charge yout card"
